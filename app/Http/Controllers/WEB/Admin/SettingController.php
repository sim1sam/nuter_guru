...
class SettingController extends Controller
{
    ...
    public function updateStatisticsColor(Request $request){
        $setting = Setting::first();
        $setting->statistics_color = $request->statistics_color;
        $setting->save();
    ...
    public function updateStatisticsFontColor(Request $request){
        $setting = Setting::first();
        $setting->statistics_font_color = $request->statistics_font_color;
        $setting->save();
