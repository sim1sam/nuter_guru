                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="themeColor-tab" data-toggle="tab" href="#themeColorTab" role="tab" aria-controls="themeColorTab" aria-selected="true">{{__('Theme color')}}</a>
                                        </li>

                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="statisticsColor-tab" data-toggle="tab" href="#statisticsColorTab" role="tab" aria-controls="statisticsColorTab" aria-selected="true">{{__('Statistics Color')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                            ...
                                            <div class="tab-pane fade" id="statisticsColorTab" role="tabpanel" aria-labelledby="statisticsColor-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-statistics-color') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Statistics Section Background Color')}}</label>
                                                                <input type="color" class="form-control" name="statistics_color" value="{{ $setting->statistics_color ?? '#2c3e50' }}">
                                                            </div>

                                                            <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                                        </form>
                                                        
                                                        <form action="{{ route('admin.update-statistics-font-color') }}" method="POST" class="mt-3">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('Statistics Section Font Color')}}</label>
                                                                <input type="color" class="form-control" name="statistics_font_color" value="{{ $setting->statistics_font_color ?? '#ffffff' }}">
                                                            </div>
