                                        ...
                                        <div class="col-md-4 mb-2">
                                            <label class="border rounded p-2 d-block mb-0 weight-variant-card">
                                                ...
                                                <div class="custom-price-wrap mt-1" style="display:none;">
                                                    ...
                                                    <input type="number" step="0.01" min="0" class="form-control form-control-sm weight-custom-price" name="weight_variant_prices[{{ $wv->id }}]" value="{{ $customPrice }}" placeholder="0.00">
                                                </div>
                                            </label>
                                        </div>
                                        @endforeach
